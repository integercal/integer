...
namespace Integer.UnitTests.Domain.Agenda
{
    public class ConflitoTest
    {
        ...
        public ConflitoTest() 
        {
            ...
            conflito = new Conflito(evento, MotivoConflitoEnum.ExisteEventoPrioritarioNaData);
        }
        ...
        {
            Assert.Equal(MotivoConflitoEnum.ExisteEventoPrioritarioNaData, conflito.Motivo);
        }
    }
}
