...
//        {
//            DateTime dataInicioEvento = eventoParoquialExistente.DataFim.AddMinutes(58);
...
//            Assert.Throws<EventoPrioritarioException>(() => agendaEventoService.Agendar(eventoNovoNaoParoquial));
//        }
...
//        {
//            DateTime dataFimEvento = eventoParoquialExistente.DataInicio.AddHours(-1);
//            DateTime dataInicioEvento = dataFimEvento.AddHours(-1);
//            var eventoNovoNaoParoquial = CriarEvento(TipoEventoEnum.Comum, dataInicioEvento, dataFimEvento);
...
//            Assert.Throws<EventoPrioritarioException>(() => agendaEventoService.Agendar(novoEvento));
//        }
